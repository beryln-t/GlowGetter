export default function () {
  return (
    <div className="flex flex-row flex-wrap max-w-custom gap-5 justify-start ">
      <div className="card flex flex-col bg-base-100 shadow-xl w-80  p-5">
        <div className="flex flex-col items-center relative">
          ...
          <div className="flex flex-col justify-start w-full">
            <p className="text-base font-extrabold leading-7	">product brand</p>
            <p className="text-sm leading-7	">product name</p>
            <p className="text-sm font-semibold leading-7	">product name</p>
          </div>
        </div>
      </div>
      <div className="card flex flex-col bg-base-100 shadow-xl w-80  p-5">
