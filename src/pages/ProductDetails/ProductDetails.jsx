export default function () {
  return (
    <div className="hero min-h-screen bg-stone-50 flex flex-row flex-wrap justify-center items-center gap-7 p-5">
      <img
      ...
      <div className="flex-col w-full max-w-2xl min-w-0 p-3 flex-shrink-0 overflow-hidden">
        <div className="flex-col space-y-3">
          ...
          <p className="text-xl text-justify font-thin">
            A superb creamy sunscreen with Adaptable Innershield Technology that
            supports the skin’s natural protective abilities and powerfully
            defends against the sun’s damaging rays, selectively allowing the
            latent benefits of red light in sunlight to pass through to the
            skin.
          </p>
